...
const dictionary = {
  ...
  hero: {
    title: "Get your Dutch tax return done. Belastingaangifte stress-free, fast, and done right.",
    description: "Navigating Dutch taxes as an expat? We take care of your entire tax return, from deductions to dual-tax systems, so you can relax. You provide the info and we handle the rest. <br><br/><ul><li>✔ No mistakes. Checked by experts</li><li>✔ Fast service. Contact within 24 hours</li><li>✔ Maximum refund. We know all the smart deductions</li></ul>",
    callToAction: "Want reliable and easy help with your tax return? Enter your contact details in the chat and one of our tax experts will reach out within 24 hours with a tailored offer. Jan de Belastingman shows that tax returns can be easy and trustworthy",
