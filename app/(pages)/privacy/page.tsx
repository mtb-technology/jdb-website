    ...
    <main className="relative flex-1 flex flex-col pt-20">
      ...
      <div className="flex-1 overflow-y-auto">
        <article className="max-w-4xl prose text-gray-500 mx-auto px-6 py-12">
          ...
          <h3>Introduction</h3>
          <p>
            Jan de Belastingman attaches great importance to the careful
            handling of your personal data (data that can be traced back to a
            natural person). Personal data is therefore carefully processed and
            secured by us, in accordance with the requirements set out in the
            General Data Protection Regulation (the AVG).
            <br />
            <br />
            ...
            <br />
            <br />
            This privacy policy is not an agreement and we may update this
            privacy policy.
            <br />
            <br />
          </p>
          ...
          <p>
            ...
            (personalized advertising and direct marketing) and profiling
            purposes (combining data).
            <br />
            <br />
          </p>
          <h2>Basis</h2>
          ...
          <p>
            ...
            accordance with this privacy policy. You are always free to refuse
            or withdraw your consent. In that case it will not be possible to
            give effect to your request for advice.
          </p>
          <h3>
          ...
          <p>
            ...
            answer questions. However, it is true that we will not be able to
            help you or provide you with tax advice.
          </p>
          <h3>Who receives your personal data?</h3>
          <p>
            Jan de Belastingman may share the personal data you provide with
            third parties for commercial and promotional purposes.
          </p>
          <p>
          ...
          <p>
            Your data will not be passed on to third parties outside the
            European Union.
          </p>
          <h3>Automated data collection</h3>
          <p>
            We use cookies when offering our services. A cookie is a simple
            small file that is sent with pages of our website and stored on your
          ...
          <p>
            ...
            purpose of file and duty of care and the position of proof and
            further to comply with laws and regulations. After expiration of the
            retention periods, we will delete your data.
          </p>
          <h3>Security of your data</h3>
          <p>
            Jan de Belastingman strives to protect the personal data it
            processes as well as possible. We therefore take appropriate
            security measures to ensure the safety of your data. If nevertheless
            a data breach should occur, we will deal with it in accordance with
            the requirements of the AVG.
          </p>
          <p>
            <br />
          </p>
          ...
          <p>
            If you have any questions or comments, or wish to exercise your
            rights described in this privacy statement, please contact us:
          </p>
          ...
          <p>
            You also have the right to file a complaint with the Dutch
            supervisory authority, the Authority for Personal Data.
          </p>
        </article>
      </div>
      <Footer dict={dict} />
